            ...
            <div className="p-4">
                ...
                {editItemId === "" ? (
                    <form className="mb-4" onSubmit={handleCreateItem}>
                        ...
                        <button className="bg-blue-500 text-white px-4 py-2 rounded-lg" type="submit">Add item</button>
                    </form>
                ) : (
                    <form className="mb-4">
                        <div className="flex flex-wrap -mx-2 mb-4">
                        ...
                        <button className="bg-blue-500 text-white px-4 py-2 rounded-lg" type="submit" onClick={(e) => handleUpdateItem(e)}>Submit Update</button>
                        <button className="bg-orange-500 text-white px-4 py-2 rounded-lg" type="submit" onClick={(e) => abortUpdateItem(e)}>Abort Update</button>
                    </form>
                )}
            </div>
                ...
                <tbody>
                    {inventory.map((item) => (
                        <tr key={item.id}>
                            ...
                            <td>{item.quantity}</td>
                            <td>
                                <button className="bg-blue-500 text-white px-4 py-2 rounded-lg mr-2" onClick={(e) => populateEditField(item)}>Update</button>
                                <button className="bg-red-500 text-white px-4 py-2 rounded-lg" onClick={(e) => handleDeleteItem(item.id)}>Delete</button>
                            </td>
                        </tr>
                    ))}
                </tbody>
