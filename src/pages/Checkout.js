...
function Checkout() {
    ...
    const fetchInventory = async() => {
      const response = await axios.get("/stock-items", { headers: {'Content-Type':'application/json', 'Authorization': `Bearer ${authToken}`}, withCredentials: true })
      setInventory(response.data)
    }

    const fetchCustomers = async() => {
      const response = await axios.get("/customers", { headers: {'Content-Type':'application/json', 'Authorization': `Bearer ${authToken}`}, withCredentials: true })
